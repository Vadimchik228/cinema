    ...
    <div class="entries">
        <c:if test="${not empty requestScope.movies}">
            <c:forEach var="movie" items="${requestScope.movies}">
                <div class="entry" onclick="window.location.href='${pageContext.request.contextPath}/movie?movieId=${movie.id}'">
                    <img width="150" height="100" src="${pageContext.request.contextPath}/images/${movie.imageUrl}" alt="No Image"><br>
                    <a href="${pageContext.request.contextPath}/movie?movieId=${movie.id}">${movie.title}</a>
                    <div class="info">
...
<form action="${pageContext.request.contextPath}/add-movie" method="get" class="nomadic-button">
